<template>
  <div class="2xl:container 2xl:mx-auto">
    <div class="px-4 py-8">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4 md:mt-6 lg:mt-8">
        <div class="col-span-2 bg-gray-50 dark:bg-gray-800 p-4">
          <div class="flex gap-6 p-2">
            <div class="flex">
              <img class="block w-full rounded-md" :src="require(`~/assets/img/${image}.png`)" />
              <!--
              <img
                class="block w-full rounded-md"
                src="https://fakeimg.pl/350x200/85C1E9,128/000,255/?text=Python Hero&font=lobster"
                alt="image"
                loading="lazy"
              />-->
            </div>
            <div class="text-xl flex flex-col justify-center">
              <div class="text-2xl pb-3 text-left">
                <span class="text-gray-500">Hello</span>
                <span class="text-gray-800 font-semibold">{{ enrolment.tc_enrolments_tc_students_name }}</span>
              </div>
              <div class="text-lg font-meduim text-gray-700 pb-1">
                Thank for selecting to learn <span class="font-semibold">' {{ enrolment.tc_enrolments_accounts_name }}'</span> with us. We greatly appreciate
                you’ve decided to work with us in building your skill profile.
              </div>
              <div class="text-lg font-meduim text-gray-700 pb-4">We are here to make your learning experience as fruitful as possible</div>
              <button
                type="button"
                class="
                  flex
        ...
        <div class="bg-gray-50 dark:bg-gray-800 p-4 flex flex-col gap-4 items-center justify-center">
          <div>
            <h2 class="text-2xl leading-tight font-semibold text-center">Contact Us</h2>
          ...
          <div class="flex justify-center items-center">
            <svg
              ...
              style="enable-background: new 0 0 33.834 33.834"
              xml:space="preserve"
            >
              <g>
                <path
		...
		c0.229-0.449,0.664-0.77,1.185-0.837c-0.676-4.393-4.47-7.771-9.048-7.771C12.386,1,8.622,4.309,7.89,8.635z"
          ...
          <div class="text-xl text-center">Drop us a message if you have any question.</div>
          <nuxt-link :to="'/contact'" class="w-full flex justify-center">
            <button
              type="button"
              class="
                flex
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-8 md:mt-10">
        <div class="bg-gray-50 flex flex-col gap-4 items-center p-6">
          ...
          <div class="flex justify-end items-center space-x-2 pt-2">
            <div class="text-xl text-center font-medium">Get to know your lecturers for this course.</div>
          </div>
          <button
            type="button"
            class="
        ...
        <div class="bg-gray-50 flex flex-col gap-4 items-center p-6">
          ...
          <div class="flex justify-end items-center space-x-2 pt-2">
            <div class="text-xl text-center font-medium">Review what you will learn in this course.</div>
          </div>
          <button
            type="button"
            class="
        ...
        <div class="bg-gray-50 flex flex-col gap-4 items-center p-6">
          ...
          <div class="flex justify-end items-center space-x-2 pt-2">
            <div class="text-xl text-center font-medium">Find additional information about this course.</div>
          </div>
          <button
            type="button"
            class="
...
export default {
  name: 'CustomStepper',
  props: {
    enrolment: { type: Object, required: false, default: () => null },
    image: { type: String, required: false, default: 'placeholder-image' },
  },
};
</script>